...
def localization_reader(inQ):
    pass
def localization_writer(outQ):
    pass
def pathfinding_reader(inQ):
    pass
def pathfinding_writer(outQ):
    pass
def motor_control_reader(inQ):
    pass
...
if __name__ == '__main__':
    ...
    localization_writer_proc = Process(target=localization_writer, args=((localization_out_queue),))
    ...
    motor_control_reader_proc = Process(target=motor_control_reader, args=((motor_control_in_queue),))
